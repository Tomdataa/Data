...
author: |
  | a.t.w.Folkers
  | a.t.w.folkers@students.uu.nl
  | http://www.github.com/Tomdataa
date: April 2023
urlcolor: purple
linkcolor: purple
output: 
...
growth_new <- GrowthSW |>
  mutate(treat = if_else(revolutions > 0, 'revolutions', 'no revolutions'))
...
His mean and median were the same as mine, the only difference was the name of the revolution collumn in the table.
...
trade and education are important and good for a coutnry
